...
def chattering_check(button_in):
    global button_buf
    if button_in == -1:
        return False
    if button_buf[button_in] == 0:
        return True
    return False
...
def change_page(button_in):
    ...
    elif button_in == 1 and p_position != 1 and chattering_check(button_in):#上
    ...
    elif button_in == 2 and p_position != 1 and chattering_check(button_in):#下
    ...
    elif button_in == 3 and chattering_check(button_in):#右
        print(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
